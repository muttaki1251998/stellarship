      ...
      <div className="flex flex-grow mt-36">
        ...
        >
          ...
          <div className="max-w-lg mx-auto">
            <h2 className="text-5xl text-black mb-4">Free Home Evaluation</h2>
            <p className="text-black text-xl mb-4">
              Are you curious about the current value of your home? Whether
              you're planning to sell or simply want to stay informed, my free
              home evaluation service is here to help! Fill out the form and I will get back to as soon as I can!
            </p>
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center px-4 py-3 border border-white text-black focus:outline-none bg-transparent transition-all duration-500 ease-out hover:bg-[#6b65d6] hover:text-black"
              >
                <span>Send</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
